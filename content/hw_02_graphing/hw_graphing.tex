...
\graphicspath{{./content/hw_02_graphing/graphics/}{./graphics/}}
...
\begin{multipleChoice}
\choice{\begin{image}\includegraphics[width=\textwidth]{CalcPlot3D-quadric_options_incorrect1}\end{image}}
\choice[correct]{\begin{image}\includegraphics[width=\textwidth]{CalcPlot3D-quadric_options_correct}\end{image}}
\choice{\begin{image}\includegraphics[width=\textwidth]{CalcPlot3D-quadric_options_incorrect2}\end{image}}
\choice{\begin{image}\includegraphics[width=\textwidth]{CalcPlot3D-quadric_options_incorrect3}\end{image}}
\end{multipleChoice}
\end{problem}
...
\begin{multipleChoice}
\choice{\begin{image}\includegraphics[width=\textwidth]{CalcPlot3D-abs_incorrect1}\end{image}}
\choice[correct]{\begin{image}\includegraphics[width=\textwidth]{CalcPlot3D-abs_correct}\end{image}}
\choice{\begin{image}\includegraphics[width=\textwidth]{CalcPlot3D-abs_incorrect2}\end{image}}
\choice{\begin{image}\includegraphics[width=\textwidth]{CalcPlot3D-abs_incorrect3}\end{image}}
\end{multipleChoice}
\end{problem}
...
\begin{multipleChoice}
\choice[correct]{\begin{image}\includegraphics[width=.5\textwidth]{CalcPlot3D-correct_ellipse}\end{image}}
\choice{\begin{image}\includegraphics[width=.5\textwidth]{CalcPlot3D-incorrect_ellipse1}\end{image}}
\choice{\begin{image}\includegraphics[width=.5\textwidth]{CalcPlot3D-incorrect_ellipse2}\end{image}}
\end{multipleChoice}
...
\begin{multipleChoice}
\choice{\begin{image}\includegraphics[width=.5\textwidth]{CalcPlot3D-incorrect_shifted_ellipse1}\end{image}}
\choice[correct]{\begin{image}\includegraphics[width=.5\textwidth]{CalcPlot3D-correct_shifted_ellipse}\end{image}}
\choice{\begin{image}\includegraphics[width=.5\textwidth]{CalcPlot3D-incorrect_shifted_ellipse2}\end{image}}
\choice{\begin{image}\includegraphics[width=.5\textwidth]{CalcPlot3D-incorrect_shifted_ellipse3}\end{image}}
\end{multipleChoice}
\end{problem}
...
\begin{multipleChoice}
\choice{\begin{image}\includegraphics[width=.5\textwidth]{CalcPlot3D-incorrect_paraboloid1}\end{image}}
\choice{\begin{image}\includegraphics[width=.5\textwidth]{CalcPlot3D-incorrect_paraboloid2}\end{image}}
\choice{\begin{image}\includegraphics[width=.5\textwidth]{CalcPlot3D-incorrect_paraboloid3}\end{image}}
\choice[correct]{\begin{image}\includegraphics[width=.5\textwidth]{CalcPlot3D-correct_paraboloid}\end{image}}
\end{multipleChoice}
\end{problem}
...
\begin{problem}
\begin{enumerate}
\item Suppose we have a surface such that the $x$-sections at $x=C$ are always $z=y^2$. Draw and describe this surface.
\item Suppose we have a surface such that the level sets at $z=C$ are always $x^2+y^2=1$. Draw and describe this surface.
\item Suppose we have a surface such that the level sets at $z=C$ are always given by $g(x,y)=1$, for some function $g$ of $x$ and $y$. Describe this surface, and draw the surface for some ``generic'' function $g$. 
\end{enumerate}
\end{problem}
