...
\begin{multipleChoice}
\choice{\includegraphics[width = .5\textwidth]{CalcPlot3D-cone}}
\choice{\includegraphics[width = .5\textwidth]{CalcPlot3D-hyper_para1}}
\choice{\includegraphics[width = .5\textwidth]{CalcPlot3D-hyper_para2}}
\choice[correct]{\includegraphics[width = .5\textwidth]{CalcPlot3D-hyperboloid1}}
\choice{\includegraphics[width = .5\textwidth]{CalcPlot3D-hyperboloid2}}
\end{multipleChoice}
